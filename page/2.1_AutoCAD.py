...
img_Cert_1 = Image.open("Streamlit FIles/images/AutoCAD images/SourceCAD AutoCAD 2D 1.png")
img_Cert_2 = Image.open("Streamlit FIles/images/AutoCAD images/SourceCAD AutoCAD 3D 1.png")
